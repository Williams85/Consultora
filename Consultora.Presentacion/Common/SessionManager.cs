...
namespace Consultora.Presentacion
{
    public class SessionManager
    {
        ...
        const string _ListaIniciativaCompetencia = "ListaIniciativaCompetencia";
        ...
        public static List<IniciativaCompetenciaEntidad> ListaIniciativaCompetencia
        {
            get { return (List<IniciativaCompetenciaEntidad>)Session[_ListaIniciativaCompetencia]; }
            set { Session[_ListaIniciativaCompetencia] = value; }
        }
